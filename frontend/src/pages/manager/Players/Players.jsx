...
import PlayerTable from '../../admin/Players/components/PlayerTable';
import AddPlayerForm from '../../admin/Players/components/AddPlayerForm';
...
const Players = () => {
  ...
  const availablePlayers = players.filter(p => !p.status || p.status?.toLowerCase() === 'available').length;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-3 mb-6">
        ...
        <div className="bg-white dark:bg-secondary-900 overflow-hidden shadow-sm rounded-xl border border-secondary-200 dark:border-secondary-800 px-4 py-5 sm:p-6 text-center">
          <dt className="text-sm font-medium text-secondary-500 dark:text-secondary-400 truncate">Available</dt>
