const squadMembers = [
  { id: 1, name: 'MS Dhoni', role: 'Wicket-Keeper', country: 'India', price: 'Retained' },
  { id: 2, name: 'Ravindra Jadeja', role: 'All-Rounder', country: 'India', price: 'Retained' },
  { id: 3, name: 'Devon Conway', role: 'Batsman', country: 'New Zealand', price: '$800,000' },
  { id: 4, name: 'Matheesha Pathirana', role: 'Bowler', country: 'Sri Lanka', price: '$200,000' },
];
  ...
  return (
    <div className="bg-white dark:bg-secondary-900 shadow-sm rounded-xl border border-secondary-200 dark:border-secondary-800 h-full flex flex-col">
      <div className="px-6 py-5 border-b border-secondary-200 dark:border-secondary-800 flex justify-between items-center">
        <h3 className="text-lg leading-6 font-semibold text-secondary-900 dark:text-white">My Squad (CSK)</h3>
          ...
          {squadMembers.map((player) => (
            <li key={player.id} className="p-4 hover:bg-secondary-50 dark:hover:bg-secondary-800/50 transition-colors flex items-center justify-between">
              ...
              <div className="text-right">
                 <p className="text-xs font-semibold text-secondary-900 dark:text-white">{player.price}</p>
              </div>
            </li>
          ))}
        </ul>
