...
const Users = () => {
  ...
  const filteredUsers = users.filter(u => {
    ...
    const matchesStatus = statusFilter === 'All Statuses' || (u.status || 'Active').toLowerCase() === statusFilter.toLowerCase();
  ...
  return (
    <div className="space-y-6">
      ...
      <UserManagementTable users={filteredUsers} setUsers={setUsers} loading={loading} onRefresh={fetchUsers} />
